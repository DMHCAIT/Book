...
const BG_IMAGE = 'https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=1800&q=90'
const BG_FALLBACK = 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1600&q=85'
    ...
    <section className="relative w-full h-screen min-h-[640px] flex items-stretch overflow-hidden bg-[#0d1525]">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 flex items-center">
        <div className="max-w-2xl">
          ...
          {/* Main headline */}
          <h1 className="font-heading font-extrabold leading-[1.1] mb-6 text-white"
              style={{ fontSize: 'clamp(2.6rem, 6vw, 4.5rem)' }}>
            {s.heroTitle || 'Book a'}{' '}
            <span className="text-cmt-gold italic">Home Visit</span>
          </h1>
          ...
          <p className="text-white/70 text-base md:text-lg leading-relaxed mb-10 max-w-lg font-light">
            {s.heroBody || 'Expert tailors come to your door — take measurements, offer fabric choices, and deliver a perfect fit in 7 days.'}
          </p>
