      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Info card */}
            <div className="bg-cmt-navyDark rounded-2xl p-6 text-white">
              <h3 className="font-semibold mb-4 text-cmt-gold">Why Choose Us?</h3>
              {[
                ...
                <p key={p} className="text-sm text-gray-300 py-1">{p}</p>
              ))}
            </div>
          </div>
              ...
              <div>
                ...
                <div className="mt-3 flex items-start gap-2.5 bg-amber-50 border border-amber-200 rounded-xl px-4 py-3">
                  ...
                  <p className="text-sm text-amber-800">
                    A <span className="font-bold">₹200 home visit charge</span> will be applied to your booking. This is collected by the tailor at the time of visit.
                  </p>
                </div>
              </div>
